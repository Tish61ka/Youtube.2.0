...
<head>
    ...
    <link rel="stylesheet" href="../css/main.css" id="image">
    <title>GameHUB</title>
</head>
<body>
<header>
<div class="menu-burger__header">
            ...
            <nav class="header__nav">
                <ul class="menu header__menu">
                    ...
                    <li class="menu__item" id="sweeties">
                        <span class="title">Сменить тему</span>
                        <ul>
                          <li>
                              <div onclick="imgsrc(); event.preventDefault()" class="blue"></div>
                              <div onclick="imgsrc2(); event.preventDefault()" class="yellow"></div>
                              <div onclick="imgsrc3(); event.preventDefault()" class="pink"></div>
                              <a href=""><div class="purple"></div></a>
                          </li>
                        </ul>
                    </li>
            ...
            <a class="logo1" href="index.html"><img src="/pictures/лого.png" class="logo" alt="" id="logo"></a>   
