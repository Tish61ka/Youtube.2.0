    ...
    <ul class="ul_profile">
        ...
        <section>
            <form action="../functions/load_video.php" method="post" enctype="multipart/form-data">
                <div>
                <label class="label_area" for="">
                        <p>Название:</p>
                        <p class="counter">
                            <span class="count1">0</span>/25
                        </p>
                    </label> 
                    <input type="text" name="name_video" id="limitInput1" onkeyup="countLetters1();" placeholder="Введите название видео" required maxlength="25">
                </div>
                <div>
                    <label class="label_area" for="">
                        <p>Описание</p>
                    ...
                    <textarea name="discription" id="limitInput" onkeyup="countLetters();" type="text" cols="30" rows="10" placeholder="Введите описание видео" required maxlength="300"></textarea>
                </div> 
                ...
                <div>
                    ...
                    <select name="category" class="select" id="" onclick="document.getElementById('a').style.marginTop = 100 + 'px'">
                        <option disabled>Выберите категорию видео</option>
